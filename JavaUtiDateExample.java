...
import java.util.*;
public class JavaUtiDateExample
{
   @SuppressWarnings("Depreciation")
	public static void main(String[] args)
	{
	   ...
	   System.out.println("");
	   Object date3=date1.clone();//Return a copy of this object.
	   ...
	   int comparison=d1.compareTo(d2); // d1>d2      Compares two Dates for ordering
	   ...
	   System.out.println("");
       boolean r1=d1.equals(d2); //Compares two dates for equality
	   System.out.println("Result of equal() r1 : "+ r1);
	   boolean r2=d1.equals(d1);
	   System.out.println("Result of equal() r2 : "+ r2);
	   System.out.println("");
	   long count1=d1.getTime();//Returns the number of milliseconds 
